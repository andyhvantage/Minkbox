...
public class EmailVerificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        veryfyemail_btn = (Button) findViewById(R.id.profile_verify_button);
        veryfyemail_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new EmailverificationAsync().execute();
    ...
    private class EmailverificationAsync extends AsyncTask<Void, Void, String> {
        private ProgressDialog mProgressDialog;
        private JSONObject jsonObj;
        ArrayList<Integer> registrationId;
        private int status = 0;

        public EmailverificationAsync() {
        }
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(EmailVerificationActivity.this);
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                HttpPost httppost = new HttpPost(AppConstants.EMAILVERIFICATION);
                ...
                if (jsonString != null) {
                    if (jsonString.contains("result")) {
                        ...
                        if (jsonObj.getString("status").equalsIgnoreCase("200")) {
                            ...
                            status = 400;
                            if(jsonObj.getString("message")
                                    .equalsIgnoreCase("Already Verify")){
                                AppPreferences.setVerifyweb(EmailVerificationActivity.this, true);
                            }
                        } else if (jsonObj.getString("status")
        ...
        protected void onPostExecute(String result) {
            ...
            if (status == 200) {
                ...
                Toast.makeText(EmailVerificationActivity.this,
                        "Email already verified..", Toast.LENGTH_LONG).show();
