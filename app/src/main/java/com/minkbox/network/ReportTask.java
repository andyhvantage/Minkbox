...
import com.minkbox.ReportThisProduct;
...
public class ReportTask extends AsyncTask<String, Void, String> {
    ...
    public ReportTask(Context context, int productid, String bug_st) {
        this.con = context;
        bug_status=bug_st;
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            System.out.println("show all post url ---------------- " + AppConstants.REPORTPRODUCTAPI);
            HttpPost httppost = new HttpPost(AppConstants.REPORTPRODUCTAPI);
        ...
        try {
            if (status == 200) {
                try {
                    ...
                    con.startActivity(i);
                    ReportThisProduct.instance.finish();
                } catch (Exception e) {
                }
            } else if (status == 400) {
